...
const ghostStories = [
    ...
    "The EMF waves indicate one ghost… or maybe it's just your cat. Hard to say. Oh, you don't have a cat?",
    "You’re safe. The rotten energy is just you. Hydrate and take a shower.",
    "Oh absolutely... a couple from the 50s still arguing about who did the dishes the night before they passed away.",
...
const summonCreatures = [
    ...
    "🌕 A vampire programmer appears but he only codes in dark mode.",
    ...
    "🌩️ A thunder elemental electrifies your PC and now it boots instantly!",
...
const bio = "I am the GhostBot 👻 a haunted AI born in a broken laptop during a thunderstorm. I scan for spirits, cleanse bad vibes and occasionally summon chaos, always with consent.";
...
function ghostbotReply(input) {
    ...
    if (!firstMessageSent) {
        addMessage("Hello mortal! I am the GhostBot 👻 You can type: bio, scan, cleanse, summon or bye.", "bot");
